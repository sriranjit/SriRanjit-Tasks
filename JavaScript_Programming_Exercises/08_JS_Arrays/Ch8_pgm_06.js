...
items[2] = "The Statue of Liberty";

/* 3) Set one of the items using square brackets. */
console.log(items.join(" and ")); // Output: The Pyramids and The Grand Canyon and The Statue of Liberty

/* 4) Can you push more than one item at a time? */
items.push("Stonehenge", "Machu Picchu");
console.log(items.join(" and ")); // Output: The Pyramids and The Grand Canyon and The Statue of Liberty and Stonehenge and Machu Picchu
