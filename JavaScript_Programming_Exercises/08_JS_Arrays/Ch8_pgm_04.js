...
console.log( days[dayInWeek] );   // Outputs "Friday"
console.log( days[dayInWeek - 1] ); // Outputs "Thursday"
...
dayInWeek = 2;
console.log( days[dayInWeek] );   // Outputs "Wednesday"
...
console.log(getDay(4));   // Outputs "Friday"
